  ...
  <div>
    ...
    <main>
      ...
      <ol lang="ja">
        ...
        <li>https://github.com/iwamot/didit にプルリクエストを送る</li>
      </ol>
      <p lang="ja">
        masterブランチにマージされれば、あなたのページが公開されます。
      </p>
      <p lang="ja">
        機能追加やデザイン改善のプルリクエストも大歓迎です。よろしくお願いいたします。
      </p>
    </main>
    <footer>
      <p class="navi"><nuxt-link to="/">home</nuxt-link></p>
    </footer>
  </div>
</template>
